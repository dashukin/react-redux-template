...
export const POSTCSS_CONFIG_ENTRY = path.resolve(CONFIG_DIR, './postcss/application.js');

export const APP_SRC_DIR = path.resolve(ROOT_DIR, './src');
export const APP_SRC_ENTRY = path.resolve(APP_SRC_DIR, './application.js');
export const APP_SRC_TEMPLATE_ENTRY = path.resolve(APP_SRC_DIR, './index.html');
